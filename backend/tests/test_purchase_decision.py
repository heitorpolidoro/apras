...
def admin(session: Session) -> User:
    return _make_user(session, "ADMINISTRATOR", "admin_d@test.com", "11111111111")


@pytest.fixture
def director(session: Session) -> User:
    return _make_user(session, "DIRECTOR", "director_d@test.com", "22222222222")


@pytest.fixture
def manager(session: Session) -> User:
    return _make_user(session, "MANAGER", "manager_d@test.com", "33333333333")

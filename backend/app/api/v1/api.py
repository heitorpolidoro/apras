...
api_router.include_router(
    auth.router, prefix="/auth", tags=["auth"], dependencies=GLOBAL_SCOPED
)
api_router.include_router(
    tasks.router, prefix="/tasks", tags=["tasks"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    users.router, prefix="/users", tags=["users"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    categories.router,
    prefix="/categories",
...
api_router.include_router(
    roles.router, prefix="/roles", tags=["roles"], dependencies=TENANT_SCOPED
)
...
api_router.include_router(
    tenants.router, prefix="/tenants", tags=["tenants"], dependencies=GLOBAL_SCOPED
)
api_router.include_router(
    lots.router, prefix="/lots", tags=["lots"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    residents.router, tags=["residents"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    visitors.router, prefix="/visitors", tags=["visitors"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    authorizations.router, tags=["authorizations"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    access_logs.router,
    prefix="/access-logs",
...
api_router.include_router(
    projects.router, prefix="/projects", tags=["projects"], dependencies=TENANT_SCOPED
)
api_router.include_router(
...
api_router.include_router(
    finance.router, prefix="/finance", tags=["finance"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    feedback.router, prefix="/feedback", tags=["feedback"], dependencies=TENANT_SCOPED
)
api_router.include_router(
...
api_router.include_router(
    packages.router, prefix="/packages", tags=["packages"], dependencies=TENANT_SCOPED
)
api_router.include_router(
...
api_router.include_router(
    voting.votes_router, prefix="/votes", tags=["votes"], dependencies=TENANT_SCOPED
)
api_router.include_router(
    assets.router, prefix="/assets", tags=["assets"], dependencies=TENANT_SCOPED
)
api_router.include_router(

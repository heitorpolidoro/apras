...
Revision ID: 0019_drop_block_lot_from_user
Revises: 0018_add_role_to_user_type
...
revision: str = "0019_drop_block_lot_from_user"
down_revision: Union[str, Sequence[str], None] = "0018_add_role_to_user_type"
